    ...
    return (
        <Container className="login-form pt-0 ">
            <div className="form-container pt-0 border shadow-sm">
                <header className="form-container-header d-flex p-3 pe-2 border-bottom">
                ...
                <Form className="form" onSubmitCapture={sendEmail}>
                    ...
                    <Link className="form-block__links d-flex justify-content-between p-2 border-top mt-2" to="#">
                    ...
                    <Link className="form-block__links d-flex justify-content-between p-2 pt-3 border-top border-bottom" to="#">
                        <div className="d-flex ">
